...
namespace EBerzosa.Pundit.Core.Versioning
{
   ...
   public abstract class VersionRangeBase : IEquatable<VersionRangeBase>
   {
      ...
      private readonly PunditVersion _minVersion;
      private readonly PunditVersion _maxVersion;
      ...
      /// </summary>
      public PunditVersion MaxVersion
      {
      ...
      /// </summary>
      public PunditVersion MinVersion
      {
      ...
      /// <returns>True if the given version meets the version requirements.</returns>
      public bool Satisfies(PunditVersion version, VersionComparison versionComparison)
      {
      ...
      /// <returns>True if the given version meets the version requirements.</returns>
      public bool Satisfies(PunditVersion version, IVersionComparer comparer)
      {
         if (version == null)
         {
