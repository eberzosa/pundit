...
namespace EBerzosa.Pundit.Core.Versioning
{
    ...
    public partial class SemanticVersion : IFormattable, IComparable, IComparable<SemanticVersion>, IEquatable<SemanticVersion>
    {
        ...
        {
            return CompareTo(obj as EBerzosa.Pundit.Core.Versioning.SemanticVersion);
        }

        /// <summary>
        /// Compare to another SemanticVersion.
        /// </summary>
        public virtual int CompareTo(EBerzosa.Pundit.Core.Versioning.SemanticVersion other)
        {
        ...
        {
            return Equals(obj as EBerzosa.Pundit.Core.Versioning.SemanticVersion);
        }

        /// <summary>
        /// Equals
        /// </summary>
        public virtual bool Equals(EBerzosa.Pundit.Core.Versioning.SemanticVersion other)
        {
        ...
        /// </summary>
        public virtual bool Equals(EBerzosa.Pundit.Core.Versioning.SemanticVersion other, VersionComparison versionComparison)
        {
        ...
        /// </summary>
        public virtual int CompareTo(EBerzosa.Pundit.Core.Versioning.SemanticVersion other, VersionComparison versionComparison)
        {
            var comparer = new VersionComparer(versionComparison);
        ...
        /// Equals
        /// </summary>
        public static bool operator ==(EBerzosa.Pundit.Core.Versioning.SemanticVersion version1, EBerzosa.Pundit.Core.Versioning.SemanticVersion version2)
        {
        ...
        private static int Compare(EBerzosa.Pundit.Core.Versioning.SemanticVersion version1, EBerzosa.Pundit.Core.Versioning.SemanticVersion version2)
        {
