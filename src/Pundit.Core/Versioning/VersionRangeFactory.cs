...
namespace EBerzosa.Pundit.Core.Versioning
{
    ...
    public partial class VersionRange
    {
        ...
        /// </summary>
        public static readonly VersionRange AllFloating = new VersionRange(null, true, null, true, new FloatRange(FloatBehaviour.AbsoluteLatest));
        ...
        /// A range that accepts all versions, prerelease and stable, and floats to the highest.
        /// </summary>
        public static readonly VersionRange AllStableFloating = new VersionRange(null, true, null, true, new FloatRange(FloatBehaviour.Major));

        /// <summary>
        /// A range that rejects all versions
        /// </summary>
        public static readonly VersionRange None = new VersionRange(new PunditVersion(0, 0, 0), false, new PunditVersion(0, 0, 0), false);
        ...
        public static VersionRange Parse(string value, bool allowFloating)
        {
            ...
            if (!TryParse(value, allowFloating, out versionInfo))
            {
                throw new ArgumentException(
                    String.Format(CultureInfo.CurrentCulture, "Invalid Value", value));
            }
        ...
        public static bool TryParse(string value, bool allowFloating, out VersionRange versionRange)
        {
            ...
            if (allowFloating
                ...
                && charArray[0] == '*')
            {
                versionRange = new VersionRange(null, true, null, true, new FloatRange(FloatBehaviour.Major), originalString: value);
                return true;
            }
            ...
            PunditVersion minVersion = null;
            PunditVersion maxVersion = null;
            ...
            if (!String.IsNullOrWhiteSpace(minVersionString))
            {
                ...
                else
                {
                    ...
                    if (!PunditVersion.TryParse(minVersionString, out minVersion))
                    {
                        // invalid version
                        return false;
                    }
            ...
            {
                if (!PunditVersion.TryParse(maxVersionString, out maxVersion))
                {
                    // invalid version
                    return false;
                }
        ...
        /// </summary>
        public static VersionRange Combine(IEnumerable<PunditVersion> versions)
        {
        ...
        /// Returns the smallest range that includes all given versions.
        /// </summary>
        public static VersionRange Combine(IEnumerable<PunditVersion> versions, IVersionComparer comparer)
        {
            var result = None;

            if (versions.Any())
            {
                IEnumerable<PunditVersion> ordered = versions.OrderBy(v => v, comparer);
