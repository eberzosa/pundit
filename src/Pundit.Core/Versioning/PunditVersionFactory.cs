...
{
    public partial class PunditVersion
    {
        /// <summary>
        /// Creates a NuGetVersion from a string representing the semantic version.
        /// </summary>
        public new static PunditVersion Parse(string value)
        {
            Guard.NotNull(value, nameof(value));

            PunditVersion ver = null;
            if (!TryParse(value, out ver))
            {
                throw new ArgumentException(String.Format(CultureInfo.CurrentCulture, "Invalid value", value), "value");
            }
        ...
        /// </summary>
        public static bool TryParse(string value, out PunditVersion version)
        {
            version = null;
            ...
            if (value != null)
            {
                    ...
                    && !string.IsNullOrEmpty(sections.Item1))
                {
                    ...
                    if (Version.TryParse(versionPart, out systemVersion))
                    {
                        ...
                        version = new PunditVersion(version: ver,
        ...
        /// </summary>
        public static bool TryParseStrict(string value, out PunditVersion version)
        {
            version = null;

            NuGet.Versioning.SemanticVersion semVer = null;
            if (NuGet.Versioning.SemanticVersion.TryParse(value, out semVer))
            {
                version = new PunditVersion(semVer.Major, semVer.Minor, semVer.Patch, 0, semVer.ReleaseLabels, semVer.Metadata);
            }
