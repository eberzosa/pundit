...
namespace Pundit.Test.Versioning
{
   public class VersionComparerTest
   {
      ...
      [InlineData("1.1.1-ABC.1", "1.1.1", RightGreater)]
      ...
      [InlineData("1.1.1-ABC", "1.1.1-ABD", RightGreater)]
      [InlineData("1.1.1-ABD", "1.1.1-ABC", LeftGreater)]
      [InlineData("1.1.1-ABC.5", "1.1.1-ABD.2", RightGreater)]
      [InlineData("1.1.1-ABD.2", "1.1.1-ABC.5", LeftGreater)]
      public void Pundit_Compare_Test(string v1, string v2, int expectedResult)
      {
         var version1 = NuGet.Versioning.NuGetVersion.Parse(v1);
         var version2 = NuGet.Versioning.NuGetVersion.Parse(v2);

         var result = VersionComparer.Compare(version1, version2, VersionComparison.PunditVersion);
