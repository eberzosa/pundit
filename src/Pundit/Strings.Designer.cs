...
namespace Pundit.Console {
    ...
    internal class Strings {
        ...
        /// <summary>
        ///   Looks up a localized string similar to syntax: {0} resolve [-m:&lt;manifest location&gt;] [-d:&lt;depth&gt;]
        ///
        ...
        ///  &lt;manifest location&gt; is a name or path to manifest file; by default manifest is taken from the current folder
        ///  &lt;depth&gt; is a repository search depth; by default all the repositories are searched, however this can be overriden; set depth &quot;local&quot; to search only the local repository or to a number which specifies how [rest of string was truncated]&quot;;.
        /// </summary>
